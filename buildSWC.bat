...
:build
"%SDKDIR:"=%\bin\compc.exe" -source-path src -output bin\MaskedTextInput.swc -include-namespaces=http://www.adobe.com/2006/fc -namespace http://www.adobe.com/2006/fc manifest.xml -include-classes com.adobe.flex.extras.skins.MTISkin -library-path %SDKDIR%\frameworks\libs
